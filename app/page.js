    ...
    <section className="max_padd_container py-16 h-screen lg:py-32">
      <div className="flex gap-8 flex-col pt-8 xl:flex-row xl:pt-8">
        ...
        >
          ...
          <h2 className="h2">
            Front-End <span className="text-secondary">Developer</span>
          </h2>
          ...
          <p className="pt-4">
            Now, I am 20 years old. I am based in Bekasi, West Java, Indonesia.
            I am studying at Binus University majoring in Software Engineering.
            I am very passionate about improving my coding skills, UI/UX design
            & website development. I work on myself to improve my skills. I love
            making things interactive website.
          </p>
